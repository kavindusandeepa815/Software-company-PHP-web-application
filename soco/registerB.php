                ...
                <div class="col-12 py-5">
                    ...
                    <div class="col-12 col-lg-4 offset-lg-4 py-5  p-4 signInDeco">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="userRegisterBEmail" disabled value="<?php echo $email; ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Verification Code</label>
                            <input type="text" class="form-control" id="userRegisterBvcode">
                            <div class="invalid-feedback" id="userRegisterBvcodeMessage">
                                Please Enter Verification Code.
                            </div>
                        </div>
                        <div class="mb-3 d-grid">
                            <button type="button" class="btn btn-primary" onclick="userRegisterB('<?php echo $id; ?>');">Register</button>
                        </div>
                    </div>
                </div>
