        ...
        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-12 p-4 signInDeco">
                                    ...
                                    <div class="mb-3 d-grid">
                                        <button type="button" class="btn btn-primary" onclick="forgotPassword('user');">Get Verification Code</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12 py-5">
                ...
                <div class="col-12 col-lg-4 offset-lg-4 py-5  p-4 signInDeco">
                    <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-control" id="userSignInEmail" value="<?php echo $email; ?>">
                        <div class="invalid-feedback d-none" id="userSignInEmailMessage">
                            Please enter your email.
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Password</label>
                        <input type="password" class="form-control" id="userSignInPassword" value="<?php echo $password; ?>">
                        <div class="invalid-feedback" id="userSignInPasswordMessage">
                    ...
                    <div class="mb-3 d-grid">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="userSignInRemember" checked>
                    ...
                    <a href="registerA.php?id=user">Not have an account? Register Here</a>
                    </div>
                </div>
            </div>
