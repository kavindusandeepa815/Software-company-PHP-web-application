...
if (isset($_POST["id"])) {
    ...
    if (empty($email)) {
        ...
        if ($id == "user") { 
            ...
            if ($user_num == 0) {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'MaestroCrew Email Verification Code';
                $bodyContent = '
        <!DOCTYPE html>
        <html lang="en">
        <head>
    ...
    ';
            ...
            (`id`,`name`,`email`,`country_id`,`password`,`v_code`,`status_ue_id`) 
            VALUES ('" . $UserID . "','None','" . $email . "','1','Noneabc123None','" . $code . "','2') ");
    ...
    ';
                ...
                if (!$mail->send()) {
                    ...
                    $randomString = substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'), 0, 4);
                    $timestamp = time();
                    $AffiliateID = $prefix . $randomString . $timestamp;


                    Database::iud("INSERT INTO `affiliate_start` 
            (`id`,`name`,`email`,`country_id`,`password`,`v_code`,`status_ue_id`) 
            VALUES ('" . $AffiliateID . "','None','" . $email . "','1','Noneabc123None','" . $code . "','2') ");
